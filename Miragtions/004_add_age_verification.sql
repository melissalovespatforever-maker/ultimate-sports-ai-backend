...
ALTER TABLE users ADD COLUMN IF NOT EXISTS age_verified_ip INET;
...
CREATE INDEX IF NOT EXISTS idx_age_verification_audit_created_at ON age_verification_audit(created_at);
